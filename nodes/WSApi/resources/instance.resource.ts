	...
	// Update Settings fields (tool-compatible)
	{
		...
		options: [
			...
			},
			{
				...
				type: 'multiOptions',
				default: [],
				description: 'Filter which event types to receive via webhook. Leave empty to receive all events.',
				options: [
					...
					{ name: 'Logged Error', value: 'logged_error' },
					{ name: 'Logged In', value: 'logged_in' },
					{ name: 'Logged Out', value: 'logged_out' },
					...
					{ name: 'User Picture', value: 'user_picture' },
					{ name: 'User Presence', value: 'user_presence' },
					{ name: 'User Push Name', value: 'user_push_name' },
