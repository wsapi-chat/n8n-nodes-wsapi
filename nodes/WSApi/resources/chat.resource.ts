...
export const chatOperations: INodeProperties = {
  ...
  options: [
    ...
    },
    {
      ...
      description: "Request on-demand message history for a chat",
      action: "Request message history",
    },
    {
      name: "Set Ephemeral",
      value: "setEphemeral",
...
export const chatFields: INodeProperties[] = [
  // Chat ID field (tool-compatible)
  {
    ...
    description:
      "WhatsApp chat identifier. For contacts: phone + @s.whatsapp.net. For groups: group ID + @g.us",
  ...
  // Cache options for Get Chat
  {
    ...
    default: false,
    description:
      "Whether to cache the result for repeated requests with the same chat ID",
    displayOptions: {
      show: {
        resource: ["chat"],
        operation: ["getChat"],
  ...
  // Mute duration field aligned with API contract
  {
    ...
    default: "8h",
    description:
      "Duration preset for muting the chat. Choose Unmute to disable muting.",
  ...
  // Request Messages fields
  {
    ...
    required: true,
    default: "",
    description: "ID of the last known message to fetch history from",
    displayOptions: {
      show: {
        resource: ["chat"],
  ...
  {
    displayName: "Last Message Sender ID",
    name: "lastMessageSenderId",
    type: "string",
    required: true,
    default: "",
    description: "Sender ID of the last known message",
    displayOptions: {
      show: {
        resource: ["chat"],
        operation: ["requestMessages"],
  ...
  },
  {
    ...
    required: true,
    default: 50,
    description: "Number of messages to request",
    typeOptions: { minValue: 1 },
    displayOptions: {
      show: {
        resource: ["chat"],
