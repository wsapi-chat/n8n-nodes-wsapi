...
export const messageOperations: INodeProperties = {
  ...
  options: [
    ...
    },
    {
      name: "Pin Message",
      value: "pinMessage",
      description: "Pin or unpin a message in a WhatsApp chat",
...
export const messageFields: INodeProperties[] = [
  // Consolidated "To" field for all message operations (tool-compatible)
  {
    ...
    description:
      "WhatsApp contact ID or group ID. For contacts: phone number + @s.whatsapp.net (e.g., 1234567890@s.whatsapp.net). For groups: group ID + @g.us (e.g., 120363123456789@g.us)",
  ...
  },
  {
    ...
    default: "",
    description:
      "Optional JPEG thumbnail for the link preview (base64 encoded)",
  ...
  // Media URL field
  {
    ...
    default: "",
    description:
      "URL of the media file to send. Must be a publicly accessible HTTP or HTTPS URL.",
  ...
  // MIME Type field
  {
    ...
    default: "",
    description:
      "MIME type of the media file (e.g., image/jpeg, video/mp4, audio/mpeg, image/webp)",
  ...
  },
  {
    ...
    placeholder: "1234567890@s.whatsapp.net",
    description:
      "WhatsApp chat ID where the message is located. For contacts: phone number + @s.whatsapp.net. For groups: group ID + @g.us",
    hint: "Phone number must include country code without +. Example: 1234567890@s.whatsapp.net",
  },
  {
  ...
  },
  {
    ...
    default: true,
    description:
      "Whether the message being deleted was sent by the current account",
  },
  {
  ...
  },
  {
    ...
    default: "7d",
    description: "Duration for the pin (only used when pinning)",
  },
  // Advanced options
  {
