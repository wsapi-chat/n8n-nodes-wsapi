...
export const groupsOperations: INodeProperties = {
  ...
  options: [
    ...
    },
    {
      ...
      action: "Reset group invite link",
    },
    {
...
export const groupsFields: INodeProperties[] = [
  ...
  // Cache options for Get Group (exclude invite endpoints)
  {
    ...
    default: false,
    description:
      "Whether to cache the result for repeated requests with the same group ID",
    displayOptions: {
      show: {
        resource: ["groups"],
        operation: ["get"],
    ...
    options: [
      {
        ...
        default: "",
        description:
          "Phone numbers of group participants (comma-separated, with country codes)",
    ...
    options: [
      {
        name: "Add",
        value: "add",
        description: "Add participants to the group",
      },
      {
        name: "Remove",
        value: "remove",
        description: "Remove participants from the group",
      },
      {
        name: "Promote",
        value: "promote",
  ...
  // Locked Mode field
  {
    ...
    default: false,
    description:
      "Whether only admins can edit group info (name, description, picture)",
    displayOptions: {
      show: {
        resource: ["groups"],
        operation: ["setLocked"],
  ...
  // Only Admins Can Add Members field
  {
    ...
    default: false,
    description:
      "Whether only admins can add new members (false = all members can add)",
    displayOptions: {
      show: {
        resource: ["groups"],
